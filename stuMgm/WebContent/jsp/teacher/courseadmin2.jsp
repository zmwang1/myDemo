...
<html>
	...
	<body>
		<t:menu />
		<div class="main-top">
			<span class="title">老师授课</span>
		</div>
		<div class="main-body">
		        <span class="title"><h2>老师已选择授课课程</h2></span><br/>
...
<%-- 					<tr>
						<td colspan=3 class="ctrl-button">
							...
							<input type=button name="delete" value="删除"
								onclick="deleteteachercourse(courseForm1);" />
							<input type=button name="addcourse" value="添加课程"
								onclick="modifycourse(courseForm1);" />
						</td>
					</tr> --%>
				</table>
			...
			<br/>
			<span class="title"><h2>选择课程</h2></span><br/>
					...
					<tr>
						<td colspan=3 class="ctrl-button">
							...
							<input type=button name="delete" value="添加"
								onclick="addcoursetoteacher(courseForm2);" />
						</td>
					</tr>
				</table>
				<input type=hidden name="courseids" value="">
