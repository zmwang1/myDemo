					...
					<tr>
						<td colspan=9 class="ctrl-button">
							...
							<input type=button name="delete" value="删除"
								onclick="deletecourse(courseForm);" />
							<input type=button name="edit" value="修改课程信息"
								onclick="editcourse(courseForm);" />
							<!-- <input type=button name="addgrade" value="维护课程"
								onclick="modifygrade(courseForm);" /> -->
						</td>
					</tr>
				</table>
